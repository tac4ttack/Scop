...
/*   Updated: 2019/03/08 16:00:48 by fmessina         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	translate(t_scop *env, int key)
{
	if (env)
	{
		if (key == GLFW_KEY_KP_8)
			mat_translate(&env->uni_transform_val, vec3f(0.0, 0.01, 0.0));
		else if (key == GLFW_KEY_KP_5)
			mat_translate(&env->uni_transform_val, vec3f(0.0, -0.01, 0.0));
		else if (key == GLFW_KEY_KP_4)
			mat_translate(&env->uni_transform_val, vec3f(-0.01, 0.0, 0.0));
		else if (key == GLFW_KEY_KP_6)
			mat_translate(&env->uni_transform_val, vec3f(0.01, 0.0, 0.0));
		else if (key == GLFW_KEY_KP_7)
			mat_translate(&env->uni_transform_val, vec3f(0.0, 0.0, -0.01));
...
static void	rotate(t_scop *env, int key)
{
	if (env)
	{
		if (key == GLFW_KEY_HOME)
			mat_rotate(&env->uni_transform_val, -1, 'x');
		else if (key == GLFW_KEY_END)
			mat_rotate(&env->uni_transform_val, 1, 'x');
		else if (key == GLFW_KEY_DELETE)
			mat_rotate(&env->uni_transform_val, -1, 'y');
		else if (key == GLFW_KEY_PAGE_DOWN)
			mat_rotate(&env->uni_transform_val, 1, 'y');
		else if (key == GLFW_KEY_F13)
			mat_rotate(&env->uni_transform_val, -1, 'z');
