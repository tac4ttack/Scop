...
/*   Updated: 2019/02/20 17:13:39 by fmessina         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
bool	buffer_create(t_scop *env)
{
	if (env)
	{
		...
		glBufferData(GL_ARRAY_BUFFER, env->mesh->n_vertex  * 4, \
					env->mesh->vertex, GL_STATIC_DRAW);
		glVertexAttribPointer(0, 4, GL_FLOAT, GL_FALSE, \
								4 * sizeof(float), (void*)0);
		// glBufferData(GL_ARRAY_BUFFER, env->mesh->n_vertex * 3, \
		// 			env->mesh->vertex, GL_STATIC_DRAW);
